...
<head>
    <meta charset="utf-8">
    <title>Gymnast - eloifycoder software </title>
        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4 bg-secondary">
                    ...
                    <a href="{{ asset('/feature')}}" class="nav-item nav-link">Our Features</a>
                    <a href="{{ asset('/class')}}" class="nav-item nav-link">Classes</a>
                    <a href="{{ asset('/blog')}}" class="nav-item nav-link">Blog</a>
